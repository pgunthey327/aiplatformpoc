    ...
    <div className="flex-1 flex flex-col items-center justify-center gap-14 px-6 py-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
        ...
        >
          ...
          <div>
            <h2 className="text-base font-semibold text-foreground">Validate Agent</h2>
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              Run regression tests against an agent&apos;s dataset and detect behavioural drift.
            </p>
          </div>
          <span className="text-sm font-medium text-primary group-hover:underline underline-offset-4">
            Validate Agent &rarr;
        ...
        >
          ...
          <div>
            <h2 className="text-base font-semibold text-foreground">Verify Registration</h2>
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              Test a registered agent interactively by sending prompts and reviewing responses.
            </p>
          </div>
          <span className="text-sm font-medium text-primary group-hover:underline underline-offset-4">
